...
const StoriesBar = () => {
  ...
  return (
    <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl non-scrollbar overflow-x-auto px-4'>
      <div className='flex gap-4 pb-5'>
        {/* Add Story Card */}
        <div
          onClick={() => setShowModal(true)}
          className='rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 aspect-[3/4] cursor-pointer hover:shadow-lg transition-all duration-200 border-2 border-dashed border-primary-100 bg-gradient-to-b from-rose-50 to-white'
        >
          <div className='h-full flex flex-col items-center justify-center p-4'>
            <div className='size-10 bg-primary-100 rounded-full flex items-center justify-center mb-3'>
